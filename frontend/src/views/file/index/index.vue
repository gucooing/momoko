...
import { useFileIndexStore } from '@/stores/file/index'
import { FileSortField, type FileEntryInfo, type GetFileSystemListRequest } from '@/types/v1/file'
import { showRequestError } from '@/utils/request'

defineOptions({ name: 'FileIndexView' })
...
const currentPath = computed(
  () => directory.value?.parentPath || query.value.path || rootPath.value,
)
