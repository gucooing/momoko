...
const createMarketShares = (): DashboardMarketShareItem[] => [
  { value: 45, name: '北美地区', colorVar: '--el-color-primary' },
  { value: 25, name: '欧洲市场', colorVar: '--el-color-warning' },
  { value: 20, name: '亚太地区', colorVar: '--el-color-success' },
  { value: 10, name: '其他', colorVar: '--el-color-info' },
]
...
export const useDashboardAnalysisStore = defineStore('dashboard-analysis', () => {
  ...
  const operationManager = ref<DashboardStarManager>({
    title: "Today's Operation Manager",
    name: 'David Fan',
    role: '高级运营专家 / 增长黑客',
