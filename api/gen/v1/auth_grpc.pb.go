...
type AuthServiceClient interface {
	...
	// 删除已登录的设备
	DelLogin(ctx context.Context, in *DelLoginRequest, opts ...grpc.CallOption) (*DelLoginResponse, error)
}
...
func (c *authServiceClient) Devices(ctx context.Context, in *DevicesRequest, opts ...grpc.CallOption) (*DevicesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DevicesResponse)
	err := c.cc.Invoke(ctx, AuthService_Devices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) DelLogin(ctx context.Context, in *DelLoginRequest, opts ...grpc.CallOption) (*DelLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DelLoginResponse)
	err := c.cc.Invoke(ctx, AuthService_DelLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) Devices(context.Context, *DevicesRequest) (*DevicesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Devices not implemented")
}
...
func (UnimplementedAuthServiceServer) DelLogin(context.Context, *DelLoginRequest) (*DelLoginResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DelLogin not implemented")
}
...
func _AuthService_Devices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DevicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).Devices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_Devices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Devices(ctx, req.(*DevicesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthService_DelLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DelLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).DelLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_DelLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DelLogin(ctx, req.(*DelLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Devices",
			Handler:    _AuthService_Devices_Handler,
		},
		{
		...
		{
			MethodName: "DelLogin",
			Handler:    _AuthService_DelLogin_Handler,
		},
	},
