...
func (_c *AuthCreate) SetExpiresAt(v time.Time) *AuthCreate {
	_c.mutation.SetExpiresAt(v)
	return _c
}

// SetNillableExpiresAt sets the "expires_at" field if the given value is not nil.
func (_c *AuthCreate) SetNillableExpiresAt(v *time.Time) *AuthCreate {
	if v != nil {
		_c.SetExpiresAt(*v)
	}
	return _c
...
func (_c *AuthCreate) check() error {
	if _, ok := _c.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`gen: missing required field "Auth.create_time"`)}
	}
	if _, ok := _c.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`gen: missing required field "Auth.update_time"`)}
	}
	if _, ok := _c.mutation.SessionID(); !ok {
		return &ValidationError{Name: "session_id", err: errors.New(`gen: missing required field "Auth.session_id"`)}
	}
	...
	if _, ok := _c.mutation.DeviceID(); !ok {
		return &ValidationError{Name: "device_id", err: errors.New(`gen: missing required field "Auth.device_id"`)}
	}
	...
	if _, ok := _c.mutation.Device(); !ok {
		return &ValidationError{Name: "device", err: errors.New(`gen: missing required field "Auth.device"`)}
	}
	...
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`gen: missing required field "Auth.user_id"`)}
	}
	...
	if _, ok := _c.mutation.IP(); !ok {
		return &ValidationError{Name: "ip", err: errors.New(`gen: missing required field "Auth.ip"`)}
	}
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`gen: missing required field "Auth.type"`)}
	}
...
// SetExpiresAt sets the "expires_at" field.
func (u *AuthUpsert) SetExpiresAt(v time.Time) *AuthUpsert {
	u.Set(auth.FieldExpiresAt, v)
	return u
}

// UpdateExpiresAt sets the "expires_at" field to the value that was provided on create.
func (u *AuthUpsert) UpdateExpiresAt() *AuthUpsert {
	u.SetExcluded(auth.FieldExpiresAt)
	return u
}

// ClearExpiresAt clears the value of the "expires_at" field.
func (u *AuthUpsert) ClearExpiresAt() *AuthUpsert {
	u.SetNull(auth.FieldExpiresAt)
	return u
}
...
// SetExpiresAt sets the "expires_at" field.
func (u *AuthUpsertOne) SetExpiresAt(v time.Time) *AuthUpsertOne {
	return u.Update(func(s *AuthUpsert) {
		s.SetExpiresAt(v)
	})
}
...
// UpdateExpiresAt sets the "expires_at" field to the value that was provided on create.
func (u *AuthUpsertOne) UpdateExpiresAt() *AuthUpsertOne {
	return u.Update(func(s *AuthUpsert) {
		s.UpdateExpiresAt()
	})
}
...
// ClearExpiresAt clears the value of the "expires_at" field.
func (u *AuthUpsertOne) ClearExpiresAt() *AuthUpsertOne {
	return u.Update(func(s *AuthUpsert) {
		s.ClearExpiresAt()
	})
}
...
func (u *AuthUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("gen: missing options for AuthCreate.OnConflict")
	}
...
// SetExpiresAt sets the "expires_at" field.
func (u *AuthUpsertBulk) SetExpiresAt(v time.Time) *AuthUpsertBulk {
	return u.Update(func(s *AuthUpsert) {
		s.SetExpiresAt(v)
	})
}
...
// UpdateExpiresAt sets the "expires_at" field to the value that was provided on create.
func (u *AuthUpsertBulk) UpdateExpiresAt() *AuthUpsertBulk {
	return u.Update(func(s *AuthUpsert) {
		s.UpdateExpiresAt()
	})
}
...
// ClearExpiresAt clears the value of the "expires_at" field.
func (u *AuthUpsertBulk) ClearExpiresAt() *AuthUpsertBulk {
	return u.Update(func(s *AuthUpsert) {
		s.ClearExpiresAt()
	})
}
...
func (u *AuthUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("gen: OnConflict was set for builder %d. Set it on the AuthCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("gen: missing options for AuthCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
