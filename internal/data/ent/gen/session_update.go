...
func (_u *SessionUpdate) SetAccessNoise(v string) *SessionUpdate {
	_u.mutation.SetAccessNoise(v)
	return _u
}

// SetNillableAccessNoise sets the "access_noise" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableAccessNoise(v *string) *SessionUpdate {
	if v != nil {
		_u.SetAccessNoise(*v)
	}
	return _u
...
func (_u *SessionUpdate) SetRefreshNoise(v string) *SessionUpdate {
	_u.mutation.SetRefreshNoise(v)
	return _u
}

// SetNillableRefreshNoise sets the "refresh_noise" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableRefreshNoise(v *string) *SessionUpdate {
	if v != nil {
		_u.SetRefreshNoise(*v)
	}
	return _u
}
...
func (_u *SessionUpdate) check() error {
	...
	if v, ok := _u.mutation.AccessNoise(); ok {
	...
	if v, ok := _u.mutation.RefreshNoise(); ok {
	...
	if _u.mutation.UserCleared() && len(_u.mutation.UserIDs()) > 0 {
		return errors.New(`gen: clearing a required unique edge "Session.user"`)
	}
	return nil
}
...
func (_u *SessionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AccessNoise(); ok {
		_spec.SetField(session.FieldAccessNoise, field.TypeString, value)
	}
	if value, ok := _u.mutation.RefreshNoise(); ok {
...
// SetAccessNoise sets the "access_noise" field.
func (_u *SessionUpdateOne) SetAccessNoise(v string) *SessionUpdateOne {
	_u.mutation.SetAccessNoise(v)
	return _u
}

// SetNillableAccessNoise sets the "access_noise" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableAccessNoise(v *string) *SessionUpdateOne {
	if v != nil {
		_u.SetAccessNoise(*v)
	}
	return _u
...
// SetRefreshNoise sets the "refresh_noise" field.
func (_u *SessionUpdateOne) SetRefreshNoise(v string) *SessionUpdateOne {
	_u.mutation.SetRefreshNoise(v)
	return _u
}

// SetNillableRefreshNoise sets the "refresh_noise" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableRefreshNoise(v *string) *SessionUpdateOne {
	if v != nil {
		_u.SetRefreshNoise(*v)
	}
	return _u
