...
var (
	...
	builtinDefaultMenus         = []defaultMenu{
		...
		newDefaultMenu("menu_1_1", entmenu.TypeMenu, "/dashboard/home", "工作台", "HOutline:ComputerDesktopIcon", new("menu_1"), 0, ""),
		newDefaultMenu("menu_1_2", entmenu.TypeMenu, "/dashboard/analysis", "分析页", "HOutline:ChartBarIcon", new("menu_1"), 1, ""),
		newDefaultMenu("menu_1_3", entmenu.TypeMenu, "/dashboard/monitor", "监控页", "HOutline:EyeIcon", new("menu_1"), 2, ""),

		// 实例
		newDefaultMenu("menu_2", entmenu.TypeDirectory, "", "应用", "HOutline:ServerStackIcon", nil, 1, ""),
		newDefaultMenu("menu_2_1", entmenu.TypeMenu, "/instance/list", "应用列表", "HOutline:CubeIcon", new("menu_2"), 0, ""),
		newDefaultMenu("menu_2_2", entmenu.TypeMenu, "/instance/type", "应用类型", "Element:MessageBox", new("menu_2"), 1, ""),
		newDefaultMenu("menu_2_3", entmenu.TypeMenu, "/instance/terminal", "终端", "HOutline:CommandLineIcon", new("menu_2"), 2, ""),
		newDefaultMenu("menu_2_4", entmenu.TypeMenu, "/openssh/management", "SSH管理", "HOutline:CubeIcon", new("menu_2"), 3, ""),

		newDefaultMenu("menu_3", entmenu.TypeDirectory, "", "文件", "HOutline:InboxStackIcon", nil, 2, ""),
		newDefaultMenu("menu_3_1", entmenu.TypeMenu, "/file/index", "文件管理", "Element:Folder", new("menu_3"), 0, constant.Terminal),

		newDefaultMenu("menu_12", entmenu.TypeDirectory, "", "系统", "HOutline:Cog6ToothIcon", nil, 10, ""),
		newDefaultMenu("menu_12_1", entmenu.TypeMenu, "/system/user", "用户管理", "HOutline:UserGroupIcon", new("menu_12"), 0, ""),
		newDefaultMenu("menu_12_1_button_0", entmenu.TypeButton, "", "添加用户", "", new("menu_12_1"), 0, constant.UserAdd),
		newDefaultMenu("menu_12_1_button_1", entmenu.TypeButton, "", "编辑用户", "", new("menu_12_1"), 1, constant.UserEdit),
		newDefaultMenu("menu_12_1_button_2", entmenu.TypeButton, "", "删除用户", "", new("menu_12_1"), 2, constant.UserDelete),
		newDefaultMenu("menu_12_1_button_3", entmenu.TypeButton, "", "查看用户", "", new("menu_12_1"), 3, constant.UserView),
		newDefaultMenu("menu_12_2", entmenu.TypeMenu, "/system/role", "角色管理", "HOutline:IdentificationIcon", new("menu_12"), 1, ""),
		newDefaultMenu("menu_12_2_button_0", entmenu.TypeButton, "", "添加角色", "", new("menu_12_2"), 0, constant.RoleAdd),
		newDefaultMenu("menu_12_2_button_1", entmenu.TypeButton, "", "编辑角色", "", new("menu_12_2"), 1, constant.RoleEdit),
		newDefaultMenu("menu_12_2_button_2", entmenu.TypeButton, "", "删除角色", "", new("menu_12_2"), 2, constant.RoleDelete),
		newDefaultMenu("menu_12_2_button_3", entmenu.TypeButton, "", "查看角色", "", new("menu_12_2"), 3, constant.RoleView),
		newDefaultMenu("menu_12_3", entmenu.TypeMenu, "/system/menu", "菜单管理", "HOutline:ListBulletIcon", new("menu_12"), 2, ""),
		newDefaultMenu("menu_12_3_button_0", entmenu.TypeButton, "", "添加菜单", "", new("menu_12_3"), 0, constant.MenuAdd),
		...
		newDefaultMenu("menu_12_4", entmenu.TypeMenu, "/system/operation", "操作记录", "HOutline:ChartBarSquareIcon", new("menu_12"), 3, constant.SystemConfigView),
		newDefaultMenu("menu_12_5", entmenu.TypeMenu, "/system/settings", "系统配置", "HOutline:CogIcon", new("menu_12"), 4, constant.SystemConfigView),
		newDefaultMenu("menu_12_5_button_1", entmenu.TypeButton, "", "编辑系统配置", "", new("menu_12_5"), 0, constant.SystemConfigEdit),
		...
		newDefaultMenu("menu_13_2", entmenu.TypeMenu, "/extended/dialog", "对话框", "HOutline:WindowIcon", new("menu_13"), 1, constant.Dev),
		newDefaultMenu("menu_13_3", entmenu.TypeMenu, "/extended/iconSelector", "图标选择器", "HOutline:SwatchIcon", new("menu_13"), 2, constant.Dev),
		newDefaultMenu("menu_13_4", entmenu.TypeMenu, "/extended/textEllipsis", "文本省略器", "HOutline:EllipsisHorizontalIcon", new("menu_13"), 3, constant.Dev),
		newDefaultMenu("menu_13_5", entmenu.TypeMenu, "/extended/hoverAnimation", "Hover动画组件", "HOutline:CursorArrowRaysIcon", new("menu_13"), 4, constant.Dev),
		newDefaultMenu("menu_13_6", entmenu.TypeMenu, "/extended/transitionAnimation", "Transition内置动画", "HOutline:SparklesIcon", new("menu_13"), 5, constant.Dev),
		newDefaultMenu("menu_13_7", entmenu.TypeMenu, "/demo/vxeTable", "VXE Table", "HOutline:TableCellsIcon", new("menu_13"), 6, constant.Dev),
		newDefaultMenu("menu_13_8", entmenu.TypeMenu, "/exception/403", "403页面", "HOutline:NoSymbolIcon", new("menu_15"), 7, constant.Dev),
		newDefaultMenu("menu_13_9", entmenu.TypeMenu, "/exception/404", "404页面", "HOutline:QuestionMarkCircleIcon", new("menu_15"), 8, constant.Dev),
	}
