...
var keyOperationTypes = map[string]v1.OperationType{
	...
	v1.OperationDockerManagerBuildDockerImage:            v1.OperationType_OperationTypeDockerImageBuild,
	...
	v1.OperationDockerManagerPruneDockerImages:           v1.OperationType_OperationTypeDockerImagePrune,
